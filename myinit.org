...
* Swiper/Ivy/CounselSwiper gives us a really efficient incremental search with regular expressions 
...
#+BEGIN_SRC emacs-lisp
  ...
  :hook
  (python-mode . highlight-identation)
  (go-mode . highlight-identation)
  (rust-mode . highlight-identation))
